...
class RecipeRecommender:
    ...
    def search_recipes(ingredients:list=[], nutritional_req:dict={}, diet:str="", intolerances:str=""):
        ...
        search_results = pd.DataFrame(search_response.json()["results"])[["id", "image", "title"]]
...
#     diet = 'vegetarian'
#     intolerances='dairy'
#     for recipe in RecipeRecommender.search_recipes(ingredients=ingredients,intolerances=intolerances):
#         print(recipe)

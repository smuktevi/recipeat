...
class Compare:
    def nutrient_compare(self, recipes):
        ...
        for recipe in recipes:
            url = "https://api.spoonacular.com/recipes/{id}/nutritionWidget?{apikey}&defaultCss=true".format(
    ...
    def ingredient_compare(self, recipes):
        ...
        ingrd_html_list = []
        for recipe in recipes:
            url = "https://api.spoonacular.com/recipes/{id}/ingredientWidget?{apikey}&defaultCss=true".format(
                id=recipe.recipe_id, apikey=apikey6)
            payload = {}
            headers = {
                'Cookie': '__cfduid=d443da310537f29e03b78e744720641111613622052'}

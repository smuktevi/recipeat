...
class TestDatabaseInsertQuery(unittest.TestCase):
    ...
    def test_insert_query_tables(self):
        ...
        self.assertTrue(
            self.db.write(
                table="users",
                columns="user_id, name, email, height, weight, age, gender, diet, intolerances",
                data="'temp_test@gmail.com', 'temp', 'q@gmail.com', 999, 999, 12, 'temp', 'temp', 'temp'"))
        self.assertTrue(
            self.db.write(
                table="bagofingredients",
                columns="user_id, ingredient, ingredient_name, amount, unit",
                data="'temp_test@gmail.com', '12 grams sugar', 'sugar', '12', 'grams'"))
...
class TestDatabaseDeleteQuery(unittest.TestCase):
    ...
    def test_delete_query_tables(self):
        ...
        self.assertTrue(self.db.query(
            "DELETE FROM users WHERE user_id='temp_test@gmail.com'"))
        self.assertTrue(self.db.query(
            "DELETE FROM bagofingredients WHERE user_id='temp_test@gmail.com'"))

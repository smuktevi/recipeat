# render_template() invokes Jinja2 template engine for powerful operations
# in templates
from flask import *
from app import app
...
# when url inside this function is called the following function executes
# and returns to the browser page that called it.
        ...
        if 'submit' in request.form:
            ...
            if ingredient == "" or quantity == "":
                return render_template(
                    ...
                    alertmessage="Ingredient and Quantity cannot be empty! Make sure Quantity is a number!")

            # Add ingredient to database
            ingredient_obj = Ingredient(
                ingredient_full=quantity +
                " " +
                units +
                " " +
                ingredient,
            ...
            if not push_success:
                return render_template(
                    ...
                    form=form,
                    ingredients=ingredients_list,
                    alertmessage="Ingredient is already in bag!")
            ...
            return render_template(
                ...
                form=form,
                ingredients=ingredients_list,
                updatesuccess="Successfully updated ingredient!")
            ...
            return render_template(
                ...
                form=form,
                ingredients=ingredients_list,
                deletesuccess="Successfully deleted ingredient!")
...
# TODO known bug in the recipe.html. The ingredients tab opens up
# ingredient of the wrong card. Need to be fixed
        ...
        if 'submit' in request.form:
            ...
            if len(recipe_compare_list) < 2:
                return render_template(
                    ...
                    form=form,
                    recipe_list=recipe_list,
                    alertmessage="At least two recipes must be selected!")
            ...
            global nutrient_compare_html
            nutrient_compare_html = comparator.nutrient_compare(
                recipe_compare_list)
            global ingredient_compare_html
            ingredient_compare_html = comparator.ingredient_compare(
                recipe_compare_list)

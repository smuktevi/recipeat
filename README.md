...
[Functional Specification](https://github.com/smuktevi/recipeat/blob/main/docs/Functional%20Specification.pdf)  
Our Functional Specification reviews the background of our project, the user profile, our data sources, and use cases.

[Technology Review](https://github.com/smuktevi/recipeat/blob/main/docs/Technology%20Review.pdf)  
...
[Final Presentation](https://github.com/smuktevi/recipeat/blob/main/docs/Final%20Presentation.pdf)  
...
## Testing
The code that is tested in this project are in the modules folder. Unit tests are used to test the code in the modules. The unit tests must be run in a specific order, and since pytest test order is used to ensure proper unit test order; it is necessary to run the unit tests using pytest. Do __not__ stop the unit testing when running, otherwise the databases will not have executed a complete rotation of registration and deletion. Pytest also allows checking for unit test coverage.
